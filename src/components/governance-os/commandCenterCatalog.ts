...
const EXTRA_NAV_COMMANDS: CommandDefinition[] = [
  {
    ...
    state: 'ready',
    path: '/audit',
    description: 'Öffentlichen Governance-Audit mit Domain-Feld starten',
  },
  {
    id: 'nav-domain-register',
    label: 'Domain hinterlegen',
    group: 'Aktionen',
    keywords: ['domain', 'website', 'hinterlegen', 'websites', 'dns'],
    state: 'ready',
    path: '/app/websites',
    description: 'Erste Domain im Workspace verbinden und scannen',
  },
  {
    id: 'nav-assistant-workspace',
    label: 'Assistent (Workspace)',
    group: 'Aktionen',
    keywords: ['assistent', 'assistant', 'chat', 'ai', 'workspace'],
    state: 'ready',
    path: '/app/assistant',
    description: 'Volle Governance-AI-Fläche unter /app/assistant',
  },
  {
    id: 'nav-scans',
    label: 'Scans öffnen',
