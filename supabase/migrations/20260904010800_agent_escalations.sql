...
CREATE TABLE IF NOT EXISTS public.agent_escalations (
  ...
  from_org_unit_id    uuid NOT NULL REFERENCES public.agent_org_units(id) ON DELETE CASCADE,
  to_org_unit_id      uuid NOT NULL REFERENCES public.agent_org_units(id) ON DELETE CASCADE,
