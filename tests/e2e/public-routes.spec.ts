...
const publicRoutes = [
  ...
  // FE-001: Conversion-first Governance Landingpage mit Audit → Report → Generate.
  { id: 'FE-001', path: '/', label: 'Startseite', heading: /KI nicht nur prüfen\. KI kontrollieren/i },
