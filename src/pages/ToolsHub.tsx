export function ToolsHub() {
  ...
  const tools = [
    ...
    },
    {
      ...
      desc: 'URL eingeben → Set-Cookie-Header + Tracker-Scripts in 15s analysiert. Kein E-Mail-Gate, kein Account.',
      href: '/cookie-scanner',
      badge: 'TDDDG § 25',
      badgeColor: '#3b2a00',
      textColor: '#fcd34d',
      ...
      <div style={{ maxWidth: 1000, margin: '0 auto', padding: '48px 24px' }}>
        ...
        <div style={{ background: '#111', border: '1px solid #1f2937', borderRadius: 12, padding: 40, marginTop: 48, textAlign: 'center' }}>
          ...
          <p style={{ color: '#6b7280', fontSize: 16, maxWidth: 560, margin: '0 auto 28px', lineHeight: 1.6 }}>
            Mit RealSync Dynamics AI erhalten Sie automatische Audit-Reports für Ihr Unternehmen; kontinuierliches DSGVO-Monitoring mit Re-Scans und Drift-Warnungen ist Coming Soon.
          </p>
