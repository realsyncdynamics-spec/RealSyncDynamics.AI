...
import { LandingGovernanceRuntimeSurface } from '../components/landing/LandingGovernanceRuntimeSurface';
  ...
  return (
    <div className="landing-context min-h-screen bg-[rgb(3,7,18)] text-white antialiased" style={{ backgroundColor: BG, fontFamily: SANS }}>
      ...
      <main ref={revealRoot}>
          ...
          <div className="relative z-10 mx-auto grid min-h-[880px] max-w-7xl items-center gap-10 px-6 pb-20 pt-28 lg:grid-cols-[1.05fr_.95fr] lg:px-10">
            <div className="max-w-3xl">
              ...
              {/* CTA-Hierarchie (Freigabe 2026-08-23, siehe CLAUDE.md §10;
                  ...
                  Governance OS (#runtime-surface) — der Trichter soll einen Einstieg
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                <a href="#runtime-surface" className="inline-flex items-center gap-2 rounded-full border border-[#e8c98a]/45 px-7 py-3.5 font-medium text-[#fff8ee] transition hover:bg-white/5">Governance OS ansehen <ArrowRight className="h-4 w-4" /></a>
              </div>
            </div>
        ...
        <LandingGovernanceRuntimeSurface />
