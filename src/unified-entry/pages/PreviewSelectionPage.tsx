...
export default function PreviewSelectionPage() {
  ...
  const [template, setTemplate] = useState<SiteDesignTemplate>((params.get('variant') as SiteDesignTemplate) || 'enterprise-8k');
