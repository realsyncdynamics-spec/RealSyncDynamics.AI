...
export const OPTIMIZER_TIERS: OptimizerTier[] = [
  ...
  { id: 'bronze', name: 'Bronze', planKey: 'starter', tagline: 'Vollständiger Bericht', optimizerFeature: 'Alle Befunde im Detail + Re-Scan-Monitoring (Coming Soon)' },
  { id: 'silber', name: 'Silber', planKey: 'growth', tagline: 'Fix-Snippets & Monitoring', optimizerFeature: 'Fix-Snippets; tägliches Monitoring + Drift-Erkennung (Coming Soon)', highlight: true },
