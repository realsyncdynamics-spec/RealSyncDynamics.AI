-- ═══════════════════════════════════════════════════════════════════════════
--  Kanonischer Plan-Katalog — Neuausgabe für Governance Launch
-- ═══════════════════════════════════════════════════════════════════════════
--
-- Ersetzt die Katalog-Daten aus 20260802001000_canonical_plan_catalog.sql.
...
-- einer Bearbeitung der alten. Die Tabellen-, RLS- und Index-Definitionen
-- stehen weiterhin in der Migration von 20260802001000 und werden hier nicht
-- wiederholt; dieser Lauf schreibt ausschließlich Katalog-Daten.
--
-- Neu gegenüber 20260802001000:
--   - Plan `governance_launch` (349 € einmalig, purchase_mode = one_time)
--   - Spalte `price_one_time_eur` (angelegt in 20260808130000)
--
