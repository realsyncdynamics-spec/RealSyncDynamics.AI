...
const publicRoutes = [
  ...
  // FE-001: Die H1 ist über <br/> umbrochen; der Accessible Name enthält an
  // den Umbrüchen KEIN Leerzeichen ("AI ComplianceOperations OSfor Europe").
  // Der Substring muss deshalb innerhalb EINES Textknotens liegen — eine
  // umbruchübergreifende Regex ("Operations OS for Europe") schlägt fehl.
