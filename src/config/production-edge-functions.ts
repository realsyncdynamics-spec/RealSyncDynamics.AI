...
export const PRODUCTION_EDGE_FUNCTIONS_MEASURED_AT = '2026-09-06T19:56Z';
...
export const UNBACKED_CALLERS: readonly UnbackedCaller[] = [
  ...
  // Die vier Governance-OS-Eintraege (integration-credentials,
  // governance-access, evidence-anchor, microsoft365-connect) sind am
  // 2026-09-06 zwischen 13:39 und 13:41 UTC deployt worden und deshalb hier
  // entfernt — genau der Schritt, den ihr eigener Vermerk („Eintrag nach der
  // Neumessung entfernen") vorgesehen hat. `governance-decide` und
  // `microsoft365-audit-sync` standen nie hier: Beide haben keinen Aufrufer
  // im Frontend. Diese Liste fuehrt Aufrufer ohne Backend, nicht Functions
  // ohne Deploy.
];
