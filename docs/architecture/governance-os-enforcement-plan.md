...
**E6 entschieden am 2026-09-04: eigene Kanäle zuerst.** Damit sind P2-3, P2-4 und P2-5 freigegeben, P2-2 (Microsoft 365) bleibt zurückgestellt.

**Offen in P2**: P2-4 (CI/CD-Gate) und P2-5 (Bot-Governance). P2-2 (Microsoft 365) hing an E6; P2-3 (SiteOS Publish Gate), P2-4 (CI/CD-Gate) und P2-5 (Bot-Governance) sind unabhängig von den offenen Entscheidungen und folgen der Empfehlung zu E6 („eigene Kanäle zuerst"). Offen bleiben die Entscheidungen E1–E7 aus §7 und
die Phasen P2/P3.
