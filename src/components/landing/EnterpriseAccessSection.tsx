...
import { LANDING_ACCENT_VIP } from './landing-theme';
...
export function EnterpriseAccessSection() {
  ...
  return (
    /* Gold gilt unter Design-Lock v2 nur noch fuer die Premium-Stufe — und
       diese Sektion ist sie. Der Ton kommt deshalb aus `LANDING_ACCENT_VIP`
       statt aus sieben Literalen. Tailwind kann keine JS-Konstante lesen,
       darum die CSS-Variablen; die Deckkraefte stehen als eigene Werte da,
       weil ein Opacity-Modifier auf einer Variablen je nach Tailwind-Version
       still durchfallen kann und ein stummer Farbfehler schlechter ist als
       fuenf Zeilen mehr. */
    <section
      id="enterprise"
      ...
      style={
        {
          '--vip': LANDING_ACCENT_VIP,
          '--vip-80': `${LANDING_ACCENT_VIP}cc`,
          '--vip-65': `${LANDING_ACCENT_VIP}a6`,
          '--vip-50': `${LANDING_ACCENT_VIP}80`,
          '--vip-40': `${LANDING_ACCENT_VIP}66`,
          '--vip-10': `${LANDING_ACCENT_VIP}1a`,
        } as CSSProperties
      }
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="grid gap-14 lg:grid-cols-[.85fr_1.15fr] lg:items-start">
          <div>
            <p className="font-mono text-[10px] tracking-[.25em] text-[var(--vip)]">ENTERPRISE-ZUGANG</p>
            <h2
              id="enterprise-heading"
              className="mt-4 text-[2rem] tracking-tight sm:text-5xl"
              style={{ fontFamily: "Georgia, 'Times New Roman', serif", fontWeight: 500 }}
            >
              Governance mit <span className="text-[var(--vip)]">Ansprechpartner.</span>
            </h2>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-full bg-[#f0e6d2] px-7 py-3.5 font-semibold text-[#1a1714] transition hover:bg-[#f6efe4] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--vip)] focus-visible:ring-offset-2 focus-visible:ring-offset-[rgb(3,7,18)]"
              >
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-full border border-[var(--vip-40)] px-7 py-3.5 font-medium text-[#f3d9a0] transition hover:border-[var(--vip-65)] hover:bg-[var(--vip-10)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--vip-50)]"
              >
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="surface-panel rounded-2xl p-6 sm:col-span-2" data-reveal data-reveal-group="enterprise">
              <p className="font-mono text-[10px] tracking-[.2em] text-[var(--vip-80)]">IM ZUGANG ENTHALTEN</p>
              <ul className="mt-4 grid gap-2.5 sm:grid-cols-2">
                {accessPoints.map((point) => (
                  <li key={point} className="flex items-start gap-2.5 text-sm leading-relaxed text-white/60">
                    <span className="mt-2 h-1 w-1 shrink-0 rounded-full bg-[var(--vip)]" />
                    {point}
                  </li>
                ))}
              </ul>
...
function AccessCard({
  ...
  return (
    <div className="surface-panel rounded-2xl p-6" data-reveal data-reveal-group="enterprise">
      <Icon className="h-5 w-5 text-[var(--vip)]" strokeWidth={1.5} />
