-- ═══════════════════════════════════════════════════════════════════════════
--  Kanonischer Plan-Katalog — Legal SSOT / Monitoring Coming Soon copy sync
-- ═══════════════════════════════════════════════════════════════════════════
--
-- Ersetzt die Katalog-Daten aus 20260912171000_canonical_plan_catalog.sql.
-- Nur Marketing-Copy in technical_subheadline / features (Coming Soon für
-- Dauer-Monitoring; TISAX/DORA als Roadmap). Keine Limit-/Entitlement-Änderung.
--
...
INSERT INTO public.plan_catalog (
  ...
  (
    ...
    0,
    0,
    '{"bots":0,"answersPerMonth":0,"domains":1,"sites":0,"automationRunsPerMonth":0,"seats":1,"apiCallsPerMonth":0,"tenants":1,"evidenceStorageGb":0.5,"auditReportsPerMonth":1,"remediationPlans":0,"bulkJobsPerMonth":0,"apiKeys":0,"industrialOtSystems":1}'::jsonb,
    '["dsgvo","audit_center","compliance_reports"]'::jsonb,
    '{"scheduler":false,"api":false,"webhooks":false,"whiteLabelReports":false,"whiteLabelDashboard":false,"multiTenant":false,"evidenceVault":false,"auditExport":false,"sso":false,"bulkOperations":false,"provenanceSigning":false,"prioritySupport":false,"siteosBuilder":false,"siteosPublish":false}'::jsonb,
    '[]'::jsonb,
    '[]'::jsonb,
    '{"audit_evidence":["Runtime-Scan einer Domain mit Governance Score 0–100","Top-3-Risiken mit Paragraphenbezug","Kompakter PDF-Bericht","Prüfpfad einsehbar (kein Export)"],"ai_governance":["DSGVO-Basisprüfung","Automatische Planempfehlung auf Basis des Scores"],"automation_ops":["Kein Account, kein Setup erforderlich","SiteOS Builder: Preview unter /build — kein Publish, keine Tenant-Site"],"multi_tenant_reseller":[]}'::jsonb,
    'community'
  ),
  (
    'starter',
    ...
    'DSGVO- und AI-Act-Scan mit lückenloser Hash-Chain und exportierbarem Prüfpfad. Dauerhafte Domain-Überwachung: Coming Soon.',
    79,
    790,
    NULL,
    'EUR',
    ...
    1,
    500,
    '{"bots":1,"answersPerMonth":500,"domains":1,"sites":1,"automationRunsPerMonth":25,"seats":1,"apiCallsPerMonth":0,"tenants":1,"evidenceStorageGb":2,"auditReportsPerMonth":2,"remediationPlans":5,"bulkJobsPerMonth":0,"apiKeys":0,"industrialOtSystems":5}'::jsonb,
    ...
    '{"scheduler":false,"api":false,"webhooks":false,"whiteLabelReports":false,"whiteLabelDashboard":false,"multiTenant":false,"evidenceVault":true,"auditExport":true,"sso":false,"bulkOperations":false,"provenanceSigning":false,"prioritySupport":false,"siteosBuilder":true,"siteosPublish":true}'::jsonb,
    '["website"]'::jsonb,
    '["whatsapp"]'::jsonb,
    '{"audit_evidence":["Vollständiger DSGVO-Scan mit Paragraphenbezug","Evidence Vault mit Hash-Chain-Verifizierung","Audit-Export als PDF und JSON","Lückenloser Prüfpfad über alle Läufe"],"ai_governance":["Policy Packs: DSGVO und EU AI Act","Generator für Datenschutzerklärung","Technische Consent-Empfehlungen"],"automation_ops":["Kontinuierliches Monitoring (Coming Soon)","E-Mail-Alert bei neuen Findings","25 Automationsläufe pro Monat","1 Governance-Bot mit 500 Antworten (Website)","1 SiteOS-Website (Create/Claim); Publish-Berechtigung — öffentliches Deploy Preview"],"multi_tenant_reseller":[]}'::jsonb,
    'email'
  ),
  (
    'growth',
    ...
    'Runtime-Läufe mit Risk Register und Policy Engine über drei Rahmenwerke. Tägliches Drift-Monitoring: Coming Soon.',
    249,
    2490,
    NULL,
    'EUR',
    ...
    2,
    2000,
    '{"bots":2,"answersPerMonth":2000,"domains":3,"sites":3,"automationRunsPerMonth":100,"seats":5,"apiCallsPerMonth":5000,"tenants":1,"evidenceStorageGb":10,"auditReportsPerMonth":12,"remediationPlans":20,"bulkJobsPerMonth":10,"apiKeys":3,"industrialOtSystems":25}'::jsonb,
  ...
  (
    ...
    10,
    25000,
    '{"bots":10,"answersPerMonth":25000,"domains":10,"sites":10,"automationRunsPerMonth":500,"seats":15,"apiCallsPerMonth":50000,"tenants":1,"evidenceStorageGb":50,"auditReportsPerMonth":50,"remediationPlans":100,"bulkJobsPerMonth":100,"apiKeys":10,"industrialOtSystems":200}'::jsonb,
    ...
    '{"scheduler":true,"api":true,"webhooks":true,"whiteLabelReports":true,"whiteLabelDashboard":false,"multiTenant":false,"evidenceVault":true,"auditExport":true,"sso":false,"bulkOperations":true,"provenanceSigning":true,"prioritySupport":true,"siteosBuilder":true,"siteosPublish":true}'::jsonb,
  ...
  (
    ...
    20,
    50000,
    '{"bots":20,"answersPerMonth":50000,"domains":25,"sites":25,"automationRunsPerMonth":2000,"seats":50,"apiCallsPerMonth":250000,"tenants":5,"evidenceStorageGb":200,"auditReportsPerMonth":200,"remediationPlans":500,"bulkJobsPerMonth":500,"apiKeys":50,"industrialOtSystems":-1}'::jsonb,
    ...
    '{"scheduler":true,"api":true,"webhooks":true,"whiteLabelReports":true,"whiteLabelDashboard":true,"multiTenant":true,"evidenceVault":true,"auditExport":true,"sso":true,"bulkOperations":true,"provenanceSigning":true,"prioritySupport":true,"siteosBuilder":true,"siteosPublish":true}'::jsonb,
    '["website","whatsapp","telegram","slack","teams","email","voice"]'::jsonb,
    '["response_pack","voice","compliance_pack","agency_bot_pack","white_label"]'::jsonb,
    '{"audit_evidence":["Alles aus Agency","Audit Center Pro mit 200 Berichten pro Monat","Evidence Vault Enterprise mit 200 GB Nachweisspeicher"],"ai_governance":["Policy Packs live: DSGVO, EU AI Act, ISO 27001, NIS2; TISAX/DORA Roadmap / auf Anfrage","Erweiterte Analysen und Risk Scoring","Eigene Richtlinien und Kontrollkataloge"],"automation_ops":["Individuell dimensionierte Scheduler- und Automation-Kontingente.","API Premium mit 250.000 Aufrufen pro Monat","20 Governance-Bots mit 50.000 Antworten (alle Kanäle)","Priorisierter Support mit vertraglich vereinbarter Reaktionszeit"],"multi_tenant_reseller":["Multi-Tenant-Dashboard für bis zu 5 Organisationen","Zentrale Benutzerverwaltung mit Rollen und Rechten","Single Sign-On","White-Label mit Branding, Logo und Farben"]}'::jsonb,
    'dedicated'
  ),
  (
    'partner',
    ...
    50,
    100000,
    '{"bots":50,"answersPerMonth":100000,"domains":100,"sites":50,"automationRunsPerMonth":10000,"seats":100,"apiCallsPerMonth":1000000,"tenants":50,"evidenceStorageGb":500,"auditReportsPerMonth":500,"remediationPlans":-1,"bulkJobsPerMonth":-1,"apiKeys":-1,"industrialOtSystems":-1}'::jsonb,
    '["dsgvo","eu_ai_act","iso_27001","nis2","tisax","dora","policy_engine","evidence_vault","audit_center","risk_register","monitoring","compliance_reports","automation_engine","alerts","workflows","drift_detection","remediation","background_jobs","scheduler","n8n","kodee","bulk_jobs","ai_bots","website_chat","whatsapp","telegram","voice","multi_channel_messaging","api","webhooks","human_handoff"]'::jsonb,
    '{"scheduler":true,"api":true,"webhooks":true,"whiteLabelReports":true,"whiteLabelDashboard":true,"multiTenant":true,"evidenceVault":true,"auditExport":true,"sso":true,"bulkOperations":true,"provenanceSigning":true,"prioritySupport":true,"siteosBuilder":true,"siteosPublish":true}'::jsonb,
    '["website","whatsapp","telegram","slack","teams","email","voice"]'::jsonb,
    '["response_pack","whatsapp","voice","compliance_pack","agency_bot_pack","white_label"]'::jsonb,
    '{"audit_evidence":["Alles aus Enterprise","500 GB Nachweisspeicher, 500 Audit-Berichte pro Monat","Unbegrenzte Behebungspläne und Bulk Jobs"],"ai_governance":["Aktive Policy Packs je Mandant; TISAX/DORA Roadmap / auf Anfrage","Mandantenspezifische Richtlinien und Kontrollkataloge"],"automation_ops":["10.000 Automationsläufe pro Monat","Voller API-Zugriff mit 1 Mio. Aufrufen pro Monat","50 Governance-Bots mit 100.000 Antworten, mandantengetrennt","SLA 4 h auf Fehlermeldungen mit festem Ansprechpartner"],"multi_tenant_reseller":["Multi-Tenant-Dashboard für bis zu 50 Mandanten","White-Label-Subdomain je Mandant","Vollständiges Branding: Logos, Farben, Texte","Mandanten-Isolation mit Unterkonten","Unbegrenzte API-Schlüssel"]}'::jsonb,
    'dedicated'
  ),
  (
    'governance_launch',
    ...
    1,
    1000,
    '{"bots":1,"answersPerMonth":1000,"domains":1,"sites":1,"automationRunsPerMonth":10,"seats":3,"apiCallsPerMonth":0,"tenants":1,"evidenceStorageGb":5,"auditReportsPerMonth":5,"remediationPlans":0,"bulkJobsPerMonth":0,"apiKeys":0,"industrialOtSystems":1}'::jsonb,
    '["dsgvo","policy_engine","evidence_vault","audit_center","compliance_reports"]'::jsonb,
    '{"scheduler":false,"api":false,"webhooks":false,"whiteLabelReports":false,"whiteLabelDashboard":false,"multiTenant":false,"evidenceVault":true,"auditExport":true,"sso":false,"bulkOperations":false,"provenanceSigning":false,"prioritySupport":false,"siteosBuilder":true,"siteosPublish":false}'::jsonb,
    '["website"]'::jsonb,
    '[]'::jsonb,
