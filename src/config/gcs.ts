...
export const GCS_PACKAGES: GcsPackage[] = [
  {
    ...
    maxScore: 30,
    tierId: 'starter',
    bullets: ['DSGVO-Scans (Monitoring: Coming Soon)', 'Evidence Vault', 'Basis-Dokumente', '1 Organisation'],
  },
  {
    id: 'business',
    name: 'Business',
    coverage: 'KI-Governance & Risk Register für wachsende Datenflüsse (Continuous Monitoring: Coming Soon)',
    minScore: 31,
    maxScore: 55,
    tierId: 'growth',
    bullets: ['KI-Governance', 'AI Risk Register', 'Continuous Monitoring (Coming Soon)', 'Drift-Detection (Coming Soon)'],
  },
  {
    id: 'professional',
    name: 'Professional',
