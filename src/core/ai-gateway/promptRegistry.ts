// Prompt Registry — every system prompt that the platform ships through
// the AI Gateway lives here. Product features look up prompts by key,
// never inline their own. Versions are date-stamped so audit logs can
// reproduce a model output years later.
...
export interface PromptEntry {
  version: string;
  /** Short purpose tag for analytics + audit logs. */
  feature: string;
