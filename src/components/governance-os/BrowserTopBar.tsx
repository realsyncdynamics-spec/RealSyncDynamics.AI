  ...
  return (
    <header className="h-14 shrink-0 bg-obsidian-900/95 border-b border-titanium-900/80 backdrop-blur-md flex items-center gap-3 px-3 sm:px-4">
      ...
      <button
        ...
        className="lg:hidden text-titanium-400 hover:text-titanium-100 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-cyan-400/50"
      ...
      <Link to="/app" className="flex items-center gap-2 shrink-0">
        <div className="w-7 h-7 bg-gradient-to-br from-cyan-400 to-sky-500 flex items-center justify-center">
        ...
        <div className="hidden sm:flex flex-col leading-none">
          ...
          <span className="font-mono text-[9px] text-cyan-400/70 tracking-wide">
      ...
      <div className="flex items-center gap-1.5 shrink-0">
        <button
          ...
          className="hidden sm:flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-medium text-titanium-300 bg-obsidian-800 border border-titanium-800 hover:border-cyan-400/40 hover:text-titanium-50 transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-cyan-400/50"
          aria-label="Command Center öffnen"
        >
          <Search className="h-3.5 w-3.5 text-cyan-400/80" />
