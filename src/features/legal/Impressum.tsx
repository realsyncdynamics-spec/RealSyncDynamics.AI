...
export function Impressum() {
  ...
  return (
    <div className="min-h-screen bg-obsidian-950 text-titanium-100">
      ...
      <div className="sr-only">Umsatzsteuer-Identifikationsnummer</div>
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-8 space-y-6 text-titanium-300 text-sm leading-relaxed">
        ...
        <Section title="Kontakt">
          <p>
            ...
            E-Mail: <a className="text-security-400" href="mailto:info@realsyncdynamicsai.de">info@realsyncdynamicsai.de</a><br />
