        ...
        <div className="max-w-4xl mx-auto space-y-10">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 border border-emerald-900 bg-emerald-950/30 text-emerald-300 text-xs font-bold uppercase tracking-wider rounded-none mb-5">
              <Euro className="h-3 w-3" /> Tools statt Beratung · Self-Service ab 49 €/M · Made in Germany
            </div>
            ...
            <p className="text-lg text-titanium-300 max-w-2xl mx-auto leading-relaxed">
              ...
              Wir liefern <strong className="text-titanium-50">Self-Service-Tools für die operative Umsetzung</strong> ab 49 €/Monat (Starter) —
          ...
          <div className="bg-obsidian-900 border border-titanium-900 rounded-none overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-titanium-900">
                {[
                  { f: 'Pricing-Modell', o: '4.000–12.000 €/Jahr (Abo)', r: '49–499 €/Monat (Self-Service)' },
          ...
          <Section title="Wann ist RealSync die richtige Wahl">
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-start gap-2"><Check className="h-4 w-4 text-emerald-400 shrink-0 mt-0.5" /><span>Du willst Self-Service ab 49 €/M statt Berater-Tagessätze.</span></li>
