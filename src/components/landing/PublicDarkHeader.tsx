    ...
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-6 sm:h-20 lg:px-10">
        <div className="flex min-w-0 shrink items-center gap-2.5 sm:gap-3">
          <Link
            to="/"
            className="flex shrink-0 items-center gap-2.5 rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#22d3ee]/60"
          >
          ...
          <span
            className="hidden items-center gap-1.5 rounded-md border border-[#22d3ee]/25 bg-[#22d3ee]/8 px-2 py-1 font-mono text-[9px] tracking-[.16em] text-[#67e8f9] xl:inline-flex"
