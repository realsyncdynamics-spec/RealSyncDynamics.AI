-- Reconciliation von 20260624000002_governance_os_runtime.sql (Repo) — nie in Prod angewendet.
-- Governance OS Runtime — Monitoring Sources + Alerts
-- (BEGIN/COMMIT der Originaldatei entfernt — apply_migration bringt die eigene Transaktion.)
