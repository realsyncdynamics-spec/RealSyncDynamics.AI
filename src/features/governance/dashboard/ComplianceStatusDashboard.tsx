    ...
    >
      ...
      <div className="flex flex-wrap items-start justify-between gap-4 border-b border-titanium-900 pb-4">
        <div>
          ...
          <p className="mt-2 font-mono text-[10px] uppercase tracking-[0.16em] text-titanium-500" data-testid="mandant-status-line">
            {bootstrapSteps[0]?.id === 'add-domain'
              ? 'Keine Domain hinterlegt'
              : activeTenantId
                ? 'Mandant aktiv'
                : 'Kein Workspace'}
          </p>
