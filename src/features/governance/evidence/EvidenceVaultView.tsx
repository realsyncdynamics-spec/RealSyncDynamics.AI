...
const EVIDENCE_TIMELINE: EvidenceItem[] = [
  ...
  { id: 'ev-020', ts: '28.05.2026 · 16:00', type: 'AI Classification',  title: 'Chatbot „Kodee" — Begrenzte Risikostufe',             description: 'EU AI Act Art. 50 — Transparenzpflicht aktiv. Nutzer-Information vorhanden.',              source: 'AI Act Agent',           domain: 'AI Use Case Registry',   hash: 'sha256:7a03...b11c', c2pa: true  },
];
    ...
    <div className="flex flex-col h-full min-h-0 bg-obsidian-950 text-titanium-100">
      ...
      <div className="shrink-0 grid grid-cols-2 md:grid-cols-4 border-b border-titanium-900">
        {METRICS.map((m, i) => (
          <div
            key={m.label}
            className={`px-4 py-3 ${i < METRICS.length - 1 ? 'border-r border-titanium-900' : ''}`}
          >
