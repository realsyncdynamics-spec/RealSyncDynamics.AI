...
CREATE TABLE IF NOT EXISTS public.compliance_gaps (
  ...
  -- Evidence Tracking
  evidence_item_ids TEXT[] DEFAULT '{}', -- UUIDs of evidence_items that address this gap
  related_incident_ids TEXT[] DEFAULT '{}', -- UUIDs of incidents that revealed this gap
