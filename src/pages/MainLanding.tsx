...
export function MainLanding() {
  ...
  return <div className="min-h-screen bg-[#02060d] text-white antialiased">
    <SEOHead title="RealSync Dynamics.AI — Das KI-Betriebssystem für DSGVO, EU AI Act & Code-Compliance" description="RealSync Dynamics AI überwacht Websites, KI-Systeme, Code und Nachweise kontinuierlich — DSGVO-konform, AI-Act-ready und auditierbar." canonical="/" ogTitle="Das KI-Betriebssystem für DSGVO, EU AI Act & Code-Compliance" ogDescription="AI Governance & Code Optimization OS for Trust & Value. RealSync Dynamics.AI." />
    <GovernanceHero />
