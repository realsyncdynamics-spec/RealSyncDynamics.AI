...
import { ArrowLeft, ArrowRight, Check, X, Minus, Cookie, Code, Globe } from 'lucide-react';
    ...
    <div className="min-h-screen bg-obsidian-950 text-titanium-100">
      <header className="h-14 border-b border-titanium-900 bg-obsidian-900 flex items-center px-4">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div className="font-display font-bold text-sm tracking-tight text-titanium-50">Borlabs-Alternative</div>
        </div>
      </header>
        ...
        <div className="max-w-4xl mx-auto space-y-10">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 border border-amber-900 bg-amber-950/30 text-amber-300 text-xs font-bold uppercase tracking-wider rounded-none mb-5">
              <Globe className="h-3 w-3" /> Über WordPress hinaus · 1-Zeile-Embed · KI-Compliance inklusive
            </div>
            <h1 className="text-3xl sm:text-5xl font-display font-bold text-titanium-50 tracking-tight leading-tight mb-4">
              Borlabs-Alternative — <span className="text-security-400">für alle Stacks, nicht nur WordPress</span>
            </h1>
            <p className="text-lg text-titanium-300 max-w-2xl mx-auto leading-relaxed">
              ...
              plus AVV, VVT, AI-Act-Tools — ab 49 €/Monat oder 29 €/Monat in der Full-Suite.
            </p>
          </div>
            ...
            <table className="w-full text-sm">
              <thead className="bg-obsidian-950 text-[11px] font-bold text-titanium-400 uppercase tracking-wider">
                <tr>
                  ...
                  <th className="text-center px-4 py-3 w-32">Borlabs</th>
                  <th className="text-center px-4 py-3 w-32 text-emerald-300">RealSync</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-titanium-900">
                {[
                  { f: 'Pricing', o: '99 €/Jahr (Single-Site)', r: '49 €/M Cookie-SDK Pro · 29 €/M Full-Suite' },
          ...
          <Section title="Wann Borlabs die richtige Wahl ist">
            <ul className="space-y-2 text-sm">
              <li className="flex items-start gap-2"><Check className="h-4 w-4 text-emerald-400 shrink-0 mt-0.5" /><span>Du betreibst <strong className="text-titanium-50">ausschließlich WordPress</strong> und willst ein WP-Plugin im Admin-Backend.</span></li>
              <li className="flex items-start gap-2"><Check className="h-4 w-4 text-emerald-400 shrink-0 mt-0.5" /><span>Du brauchst Service-Blocker für YouTube/Maps/Vimeo mit Wartung über das WP-Backend.</span></li>
              <li className="flex items-start gap-2"><Check className="h-4 w-4 text-emerald-400 shrink-0 mt-0.5" /><span>Du brauchst <em>nur</em> Cookie-Consent — keine weiteren DSGVO-Tools.</span></li>
            </ul>
          </Section>

          <Section title="Wann RealSync die richtige Wahl ist">
            <ul className="space-y-2 text-sm">
              <li className="flex items-start gap-2"><Check className="h-4 w-4 text-emerald-400 shrink-0 mt-0.5" /><span>Du betreibst <strong className="text-titanium-50">eine moderne Web-App</strong> (React, Vue, Next, Astro, Svelte) — Borlabs bringt nichts.</span></li>
              <li className="flex items-start gap-2"><Check className="h-4 w-4 text-emerald-400 shrink-0 mt-0.5" /><span>Du betreibst <strong className="text-titanium-50">mehrere Sites</strong> (Multi-Tenant Agentur-Setup) — Borlabs lizensiert pro Site.</span></li>
              ...
              <li className="flex items-start gap-2"><Check className="h-4 w-4 text-emerald-400 shrink-0 mt-0.5" /><span>Du willst <strong className="text-titanium-50">eine Plattform für alles</strong> (AVV, VVT, DSFA, Bußgeld-Rechner) statt 5 Tools von 5 Anbietern.</span></li>
            </ul>
          </Section>
          ...
          <div className="mt-12 p-6 sm:p-8 bg-obsidian-900 border border-security-700 rounded-none">
            <h2 className="font-display font-bold text-titanium-50 text-xl mb-2">
              Snippet kopieren, einfügen, fertig
            </h2>
            <div className="flex flex-col sm:flex-row gap-2 mt-4">
              ...
              <Link to="/contact-sales?source=borlabs-alt" className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-obsidian-950 border border-titanium-700 hover:border-security-500 text-titanium-200 text-sm font-bold rounded-none">
