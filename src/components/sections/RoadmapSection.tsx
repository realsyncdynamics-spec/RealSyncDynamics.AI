...
const ITEMS: RoadmapItem[] = [
  ...
  },
  {
    ...
    status: 'Beta',
    body:
      'Storefront-Scan für Shopify-Shops mit Tracker-, Consent- und Header-Erkennung. Erkennt mögliche Pre-Consent-Risiken und erzeugt Drift-Events nach Theme-Änderungen. Keine automatischen Änderungen am Store ohne Freigabe.',
    bullets: [
