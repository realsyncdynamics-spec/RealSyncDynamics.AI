  ...
  return (
    <div className="min-h-screen bg-obsidian-950 text-titanium-100">
      <header className="h-14 border-b border-titanium-900 bg-obsidian-900 flex items-center px-4">
        <Link to="/governance" className="p-1.5 rounded-none hover:bg-obsidian-800 text-titanium-400 hover:text-titanium-200 mr-3">
...
function NotFound() {
  return (
    <div className="text-center py-16">
      ...
      <Link to="/governance" className="text-amber-300 hover:text-amber-200 text-sm font-semibold">
