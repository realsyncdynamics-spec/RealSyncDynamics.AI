...
| `ENFORCED` seit AP9 (Welle 1–3) | **10** | `bots.appointments`, `bots.orders`, `bots.multi_channel`, `webhooks.enabled`, `alerts.email`, `governance.risk_register`, `whitelabel.reports`, `whitelabel.dashboard` (mittelbar), dazu `policy.packs`, `ai.tool.workflows` als Bestand — Nachtrag 2026-09-01, die Zeilen oben tragen den jeweiligen Stand |
| `METERED` | **0** | — |
