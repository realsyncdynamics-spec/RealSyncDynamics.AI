...
describe('pricing config (Single Source of Truth)', () => {
  it('enthaelt alle Pflicht-Tiers und Jahresvarianten in korrekter Reihenfolge', () => {
    ...
    expect(ids).toEqual(['free', 'starter', 'growth', 'agency', 'scale', 'enterprise', 'starter_yearly', 'growth_yearly', 'agency_yearly', 'scale_yearly']);
  });
  ...
  it('alle Paid-Tiers haben recurring=true', () => {
    const paid = ['starter', 'growth', 'agency', 'scale', 'enterprise', 'starter_yearly', 'growth_yearly', 'agency_yearly', 'scale_yearly'] as const;
