 ...
 * no DEMO/SIMULATED chrome. Text readability comes from the dark veil.
 */
...
function Starfield() {
  return (
    <div
      className="hero-earth-stars pointer-events-none absolute inset-0 opacity-70"
      aria-hidden="true"
      style={{
        backgroundImage: [
          'radial-gradient(1px 1px at 12% 18%, rgba(255,255,255,0.55), transparent)',
          'radial-gradient(1px 1px at 28% 42%, rgba(255,248,230,0.4), transparent)',
          'radial-gradient(1.5px 1.5px at 48% 12%, rgba(255,255,255,0.5), transparent)',
          'radial-gradient(1px 1px at 63% 28%, rgba(228,207,162,0.35), transparent)',
          'radial-gradient(1px 1px at 78% 16%, rgba(255,255,255,0.45), transparent)',
          'radial-gradient(1px 1px at 88% 48%, rgba(255,255,255,0.32), transparent)',
          'radial-gradient(1.5px 1.5px at 18% 68%, rgba(255,255,255,0.28), transparent)',
          'radial-gradient(1px 1px at 42% 78%, rgba(228,207,162,0.28), transparent)',
          'radial-gradient(1px 1px at 71% 72%, rgba(255,255,255,0.35), transparent)',
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 68% 58%, #0c1524 0%, #070b14 42%, #04060a 100%)',
        }}
      />
      <Starfield />

      {/* Soft gold/blue atmosphere wash */}
      <div
        className="absolute inset-0 opacity-40 mix-blend-screen"
        style={{
          background:
            'radial-gradient(42% 36% at 72% 62%, rgba(90,140,190,0.22) 0%, transparent 70%), radial-gradient(28% 24% at 58% 78%, rgba(228,207,162,0.12) 0%, transparent 72%)',
        }}
      />
