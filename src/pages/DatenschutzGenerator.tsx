          ...
          <div>
            ...
            <div style={{ background: '#1a1a2e', borderRadius: 8, padding: 16, marginTop: 16 }}>
              <p style={{ color: '#fbbf24', fontSize: 13, margin: 0 }}>
                ⚠️ <strong>Hinweis:</strong> Diese Datenschutzerklärung dient als Ausgangsbasis. Für rechtssichere Implementierung empfehlen wir eine Prüfung durch einen Datenschutzbeauftragten. Kontakt: <a href="mailto:datenschutz@realsyncdynamics.de" style={{ color: '#60a5fa' }}>datenschutz@realsyncdynamics.de</a>
              </p>
            </div>
          </div>
        )}
