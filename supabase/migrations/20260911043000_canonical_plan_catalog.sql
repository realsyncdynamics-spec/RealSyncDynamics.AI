-- ═══════════════════════════════════════════════════════════════════════════
--  Kanonischer Plan-Katalog — Agency wieder self_service (Dominik-Landing)
-- ═══════════════════════════════════════════════════════════════════════════
--
...
-- einer Änderung der alten.
--
-- Neu: Agency (699 €/M) ist wieder `self_service` / `purchaseMode: checkout`
-- mit Stripe Live-Price `price_1TfsV9REjTWueUcGxJIBHYgC`. Partner bleibt
-- legacy. Outcome-Headline und CTA folgen der Dominik-Landing-Referenz.
--
