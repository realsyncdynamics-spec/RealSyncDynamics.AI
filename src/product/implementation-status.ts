...
export const IMPLEMENTATION_ITEMS: readonly ImplementationItem[] = [
  ...
  },
  {
    ...
    status: 'preview',
    group: 'activation',
    description: 'Org+Scope-Persistenz und Activation-UI — Draft auf Parallel-Branch, nicht auf main.',
    evidence: ['PR #1326', 'docs/product/governance-activation.md'],
    showOnRoadmap: true,
  },
  {
  ...
  },
  {
    ...
    status: 'coming-soon',
    group: 'activation',
    description: 'Automatische Blueprint-Erzeugung in der Activation — noch nicht live.',
    evidence: ['PR #1326'],
    showOnRoadmap: true,
  },
  {
