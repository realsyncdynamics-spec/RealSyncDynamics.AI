/**
 * UI-Strings, Deutsch als Standard, Englisch per Umschalter.
 *
 * Quelle ist `design/handoff/realsync-ai-app/i18n.json` aus dem Prototyp —
 * hier als typisiertes Modul abgelegt, damit ein fehlender Schluessel beim
 * Typcheck auffaellt und nicht erst zur Laufzeit als leerer Text.
 *
 * `test/i18n/strings-parity.test.ts` haelt beides deckungsgleich: weicht
 * dieses Modul vom Handoff ab, faellt der Test. Also nicht hier von Hand
 * nachbessern, sondern im Handoff und dann uebernehmen.
 *
 * Deutsch ist Standard. Englisch ist eine Uebersetzung, keine zweite
 * Wahrheit — wo beide auseinanderlaufen, gilt Deutsch.
 */
...
export const STRINGS = {
  de: {
    navProduct: 'Produkt',
    navPricing: 'Preise',
    cta: 'Free Audit starten',
    cta2: 'Live Dashboard ansehen',
    heroA: 'AI Compliance',
    heroB: 'Operations OS',
    heroC: 'for Europe',
    sub1: 'Runtime-Governance für regulierte KI-Systeme.',
    sub2: 'Kontinuierliche Evidenz. EU-nativ by design.',
    loginTitle: 'Anmelden',
  ...
  en: {
    ...
    heroB: 'Operations OS',
    heroC: 'for Europe',
    sub1: 'Runtime governance for regulated AI systems.',
    sub2: 'Continuous evidence. EU-native by design.',
    loginTitle: 'Sign in',
...
/** Jeder Schluessel, den beide Sprachen fuehren. */
...
/**
 * Text in der gewuenschten Sprache.
 *
 * Faellt auf Deutsch zurueck, wenn eine Uebersetzung fehlt — sichtbarer
 * deutscher Text ist besser als ein leeres Element.
 */
