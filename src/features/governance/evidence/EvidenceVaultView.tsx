...
const EVIDENCE_TIMELINE: EvidenceItem[] = [
  ...
  { id: 'ev-013', ts: '07.06.2026 · 11:00', type: 'Screenshot',         title: 'Cookie-Kategorien fehlen — blog.atelier-nord.de',     description: 'TTDSG §25 Verstoß: Nur „Alle akzeptieren" oder „Alle ablehnen" möglich',                    source: 'Cookie Agent',           domain: 'blog.atelier-nord.de',   hash: 'sha256:6d40...c55e', c2pa: true  },
