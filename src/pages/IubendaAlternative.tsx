        ...
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <div className="bg-obsidian-900 border border-titanium-900 rounded-none overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-titanium-900">
                {[
                  { f: 'Pricing ab', o: '~108 €/Jahr Ultimate', r: '49 €/M Cookie-SDK Pro · 29 €/M Full-Suite' },
          ...
          <div className="mt-12 p-6 sm:p-8 bg-obsidian-900 border border-security-700 rounded-none">
            <h2 className="font-display font-bold text-titanium-50 text-xl mb-2">
              DACH-Compliance auf einer Plattform — 49 €/M
            </h2>
            <div className="flex flex-col sm:flex-row gap-2 mt-4">
              ...
              <Link to="/contact-sales?source=iubenda-alt" className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-obsidian-950 border border-titanium-700 hover:border-security-500 text-titanium-200 text-sm font-bold rounded-none">
