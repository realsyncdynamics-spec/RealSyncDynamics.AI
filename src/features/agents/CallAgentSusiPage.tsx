    ...
    <div className="space-y-6">
      ...
      <div className="bg-obsidian-900 border border-titanium-900 p-6">
        <p className="text-sm text-titanium-300">
          Coming in PR4: Telefonischer Voice-Agent mit der ElevenLabs-Stimme
          „Susi" als bevorzugte Stimme und automatischem Fallback auf eine
          deutsche weibliche Stimme über die Voice Search API.
        </p>
      </div>
    </div>
  );
