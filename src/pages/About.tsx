        ...
        <div className="max-w-3xl mx-auto space-y-10">
          ...
          <Section title="Was uns unterscheidet">
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-start gap-2">
                <Shield className="h-4 w-4 text-emerald-400 shrink-0 mt-0.5" />
                <span><strong className="text-titanium-50">Faire Preise</strong>: Free Audit kostenlos · Starter 79 €/M · Growth 249 €/M · Enterprise auf Anfrage. Keine Setup-Fees. Starter und Growth 14 Tage kostenlos testen.</span>
              </li>
            </ul>
          </Section>
