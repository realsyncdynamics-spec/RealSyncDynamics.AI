-- ═══════════════════════════════════════════════════════════════════════════
--  Kanonischer Plan-Katalog — SiteOS Builder Limits/Permissions
-- ═══════════════════════════════════════════════════════════════════════════
--
-- Ersetzt die Katalog-Daten aus 20260911043000_canonical_plan_catalog.sql.
-- Neu: PlanLimits.sites + PlanPermissions.siteosBuilder/siteosPublish
-- (Free=0 Sites/kein Publish, Starter=1, Growth=3, Agency=10).
--
