...
const publicRoutes = [
  ...
  // FE-001: Governance-first Landingpage: Audit und Website-Transformation sind der primäre Einstieg.
  { id: 'FE-001', path: '/', label: 'Startseite', heading: /Sichern Sie die Zukunft Ihres KI-gesteuerten Unternehmens/i },
