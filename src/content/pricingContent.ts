...
export const featureDetails: Feature[] = [
  {
    ...
    includedInPlans: ['Free Audit', 'Starter', 'Growth', 'Agency', 'Partner', 'Enterprise', 'Starter (Jährlich)', 'Growth (Jährlich)', 'Agency (Jährlich)', 'Partner (Jährlich)'],
  },
  {
    slug: 'consent-timing',
    ...
    includedInPlans: ['Starter', 'Growth', 'Agency', 'Partner', 'Enterprise', 'Starter (Jährlich)', 'Growth (Jährlich)', 'Agency (Jährlich)', 'Partner (Jährlich)'],
  },
  {
  ...
  },
  {
    ...
    includedInPlans: ['Growth', 'Agency', 'Partner', 'Enterprise', 'Growth (Jährlich)', 'Agency (Jährlich)', 'Partner (Jährlich)'],
  },
  {
  ...
  },
  {
    ...
    includedInPlans: ['Agency', 'Partner', 'Enterprise', 'Agency (Jährlich)', 'Partner (Jährlich)'],
  },
  {
    slug: 'bots',
    title: 'Bots',
  ...
  },
  {
    ...
    includedInPlans: ['Partner', 'Enterprise', 'Partner (Jährlich)'],
  },
  {
...
export const pricingPlans: PricingPlan[] = [
  ...
  },
  {
    ...
    whatCustomerGets: [
      'Alles aus Agency plus:',
      'Governance-Bots (bis 20, 50.000 Antworten/Monat, alle Kanäle)',
    ...
    detailedSections: [
      {
        title: 'Was macht Enterprise besonders?',
        content: 'Enterprise erweitert die Governance-Funktionen von Agency um Multi-Org-Verwaltung und SLA-Support. Der Kunde kann bis zu 5 separate Organisationen oder Business Units zentral verwalten, dabei aber strikte Datentrennung wahren. Governance-Bots ermöglichen automatisierte Kontroll- und Compliance-Workflows in großem Maßstab. Priority Support und erweiterte Analytics unterstützen Enterprise-Compliance-Anforderungen.',
      },
      {
        title: 'Für wen ist Enterprise?',
        content: 'Enterprise ist für Großunternehmen, regulierte Industrien (Finanzen, Versicherungen, Pharma), Behörden und Organisationen mit komplexer Governance gedacht. Der Plan bietet die technische Basis für Multi-Tenant-Szenarien, erweiterte Auditierbarkeit und dedizierte Support-Strukturen.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    price: 6900,
    priceString: '6.900 €',
    interval: 'pro Jahr — mehr als 2 Monatsraten Rabatt',
    recommended: false,
    badge: 'Sparen Sie über 2 Monate',
    shortDescription: 'Agency mit Jahresabrechnung: 6.900 € statt 8.388 € pro Jahr — mehr als 2 Monatsraten gespart. Branchenbibliotheken, White-Label und API-Zugriff für ein ganzes Jahr.',
    ...
    detailedSections: [
      {
        title: 'Warum die Jahresvariante?',
        content: 'Die Jahresabrechnung bündelt 12 Monate Agency für 6.900 € — weniger als 10 Monatsraten (8.388 € bei monatlicher Zahlung). Für Kanzleien und Agenturen, die Mandate über Jahresverträge abrechnen, passt die Laufzeit damit zum eigenen Geschäftsmodell. Der Funktionsumfang ist identisch zur monatlichen Variante.',
      },
    ],
    trial: {
      days: 14,
  ...
  },
  {
    ...
    recommended: false,
    badge: 'Reseller',
    shortDescription: 'Partner mit Jahresabrechnung: 19.000 € statt 23.988 € pro Jahr — mehr als 2 Monatsraten gespart. Multi-Tenant-Verwaltung für bis zu 50 Mandanten, ein ganzes Jahr.',
    ...
    detailedSections: [
      {
        title: 'Warum die Jahresvariante?',
        content: 'Die Jahresabrechnung bündelt 12 Monate Partner für 19.000 € — weniger als 10 Monatsraten (23.988 € bei monatlicher Zahlung). Multi-Tenant-Betreiber kalkulieren ihre Mandantenpreise üblicherweise auf Jahresbasis — die Jahresvariante passt Einkaufs- und Verkaufslogik aneinander an. Der Funktionsumfang ist identisch zur monatlichen Variante.',
      },
    ],
  },
];
