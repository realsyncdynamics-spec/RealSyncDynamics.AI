/**
 * Landing — minimale, stabile Startseite.
 *
 ...
 *   1. Navbar
 *   2. Hero
 *   3. „Was Sie sofort sehen" — 4 Nutzenkarten
 *   4. Evidence-Vorschau — statische Beispieldaten, klar als Demo gelabelt
 *   5. CTA-Block — drei Primärziele
 *   6. Footer
 *
 * Keine Animation, kein Auto-Scroll, kein scrollIntoView, kein Observer.
 * Die schweren Sektionen (RuntimeCanvas, LiveScan, GlobalRuntimeFeed,
 * AiActSequence, GovernanceAgents, Comparison, lange Trust- und FAQ-
 * Blöcke) sind aus dem Render-Tree entfernt — die Komponenten existieren
 * weiterhin und können auf Unterseiten gemountet werden.
 */
    ...
    <section className="border-b border-titanium-900 px-4 sm:px-6 py-16 sm:py-24">
      <div className="max-w-5xl mx-auto">
        <p className="font-mono text-[11px] uppercase tracking-[0.22em] text-titanium-500 mb-4">
          Governance-Runtime für Agenturen und Multi-Site-Betreiber
        </p>
        <h1 className="font-display font-bold tracking-tight text-titanium-50 text-3xl sm:text-5xl leading-[1.05] max-w-4xl">
          Mehrere Websites. Kontinuierlich überwacht. Audit-ready.
        </h1>
        <p className="mt-6 text-base sm:text-lg text-titanium-300 max-w-3xl leading-relaxed">
          RealSyncDynamics.AI überwacht Kunden-Websites, erkennt DSGVO-,
          Vendor- und KI-Risiken und erzeugt überprüfbare Evidence-Reports
          für Dokumentation und Review.
        </p>

        <ul className="mt-8 space-y-2 text-sm sm:text-base text-titanium-200 max-w-2xl">
          {[
            'Websites kontinuierlich prüfen',
            'Risiken priorisieren',
            'Evidence-Reports exportieren',
...
const VALUE_CARDS = [
  {
    ...
    title: 'Risiko-Score',
    body:
      'Ein Wert je Website. Zeigt auf einen Blick, ob das Property im grünen oder roten Bereich liegt.',
  },
  {
    Icon: ShieldCheck,
    title: 'Top-Findings',
    body:
      'Die wichtigsten Verstöße sortiert nach Schweregrad. Consent, Tracker, AVV, AI Act.',
  },
  {
    Icon: FileCheck,
    title: 'Evidence-Report',
    body:
      'Exportierbares PDF mit Score, Befunden und Belegen — für Dokumentation und Review.',
  },
  {
    Icon: Target,
    title: 'Nächster Schritt',
    body:
      'Pro Befund eine konkrete Handlungsempfehlung. Keine generischen Hinweise.',
  },
] as const;
