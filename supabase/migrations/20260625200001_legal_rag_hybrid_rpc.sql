...
-- [hotfix] Renamed from 20260625200000_legal_rag_hybrid_rpc.sql to avoid
-- duplicate timestamp collision with 20260625200000_governance_assets_annex_iii.sql.
...
COMMENT ON FUNCTION public.legal_retrieve_chunks_hybrid IS
  'Hybrid legal-RAG retrieval: RRF fusion of FTS + vector similarity. Falls back to FTS-only when q_vec is NULL.';
