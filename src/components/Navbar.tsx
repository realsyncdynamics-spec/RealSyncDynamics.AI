        ...
        <div className="flex justify-between h-14 items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link
              ...
              data-ki-fragen-pill
              className="group relative inline-flex items-center gap-1.5 px-3.5 py-1.5 text-sm font-semibold tracking-tight rounded-full text-violet-100 hover:text-white bg-gradient-to-br from-violet-500/10 via-fuchsia-500/10 to-violet-500/10 hover:from-violet-500/25 hover:via-fuchsia-500/25 hover:to-violet-500/25 hover:scale-[1.03] hover:shadow-[0_0_24px_-4px_rgba(168,85,247,0.45)] transition-all duration-200 motion-reduce:transition-none motion-reduce:hover:scale-100"
              style={{
                backgroundImage:
