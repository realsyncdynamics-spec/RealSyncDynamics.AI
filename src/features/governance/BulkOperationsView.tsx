      ...
      <main className="px-6 py-8">
        <div className="max-w-2xl border border-titanium-800 bg-obsidian-900 p-6">
          <div className="flex items-center gap-3 text-amber-400">
            ...
            <h2 className="font-semibold">Noch nicht implementiert</h2>
          </div>

          <p className="mt-3 text-sm leading-relaxed text-titanium-300">
            Für Massen-Importe (Gaps aus CSV, Evidence aus ZIP, Status-Updates,
            Zuordnung zu Remediation-Plänen) gibt es bisher keine Verarbeitung im
            Backend. Deshalb nimmt diese Seite auch keine Datei entgegen: ein
            Upload, der nirgends ankommt, ist schlechter als gar keiner.
          </p>

          <p className="mt-3 text-sm leading-relaxed text-titanium-400">
            Bis dahin hilft der Massen-Scan weiter — viele Domains in einem
            Batch, serverseitig eingereiht, mit echtem Fortschritt und Ergebnis.
          </p>
