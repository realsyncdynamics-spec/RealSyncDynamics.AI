...
const TOOLS = [
  ...
  },
  {
    ...
    icon: Globe2,
    text: 'AI-gestützte Websites/Apps mit Governance, Policy Checks, Evidence und kontrollierter Veröffentlichung — Domain einlesen, fotorealistisch neu bauen.',
    bullets: ['Fotorealistisches Design', 'Policy Checks', 'SiteOS-Transformation'],
  ...
  },
  {
    ...
    icon: Code2,
    text: 'Code analysieren, Risiken erkennen, Governance-Gates vor Deployment — Fixes und Prüfungen als Evidence im Entwicklungsworkflow.',
