...
export function DashboardPreviewPage() {
  ...
  // `tier: 'starter'` ist der MONATS-Plan-Key. Die Karte warb hier zuvor mit
  // „790 € / Jahr" und „12 Monate Mindestlaufzeit" und schickte den Kunden
  // anschliessend genau hierher — in ein Monatsabo zu 79 €. Betrag und
  // Laufzeit stimmten also nicht mit dem ueberein, was abgeschlossen wurde.
  // Ein Jahres-Key waere keine Loesung gewesen: fuer `starter_yearly` ist in
  // `public.products` kein echter Stripe-Preis verdrahtet.
