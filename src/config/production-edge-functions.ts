...
export const PRODUCTION_EDGE_FUNCTIONS_MEASURED_AT = '2026-09-06T20:45Z';
...
export const UNBACKED_CALLERS: readonly UnbackedCaller[] = [
  ...
  // hier mit dem Vermerk „wird mit dem naechsten deploy.yml-Lauf deployt".
  // Der Lauf ist erfolgt: Am 2026-09-06 sind alle vier live gemessen und
  // stehen jetzt in PRODUCTION_EDGE_FUNCTIONS. Damit ist ihr Eintrag hier
  // gegenstandslos — ein Aufrufer ohne Function ist keiner mehr, sobald es
  // die Function gibt.
];
