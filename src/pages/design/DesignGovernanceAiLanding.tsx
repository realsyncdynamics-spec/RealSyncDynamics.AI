/**
 * Production landing. Fold follows Brand Direction v1.0 structure
 * (Titan Europe map, loop, infra, plan pills) with Design-Lock v2 color:
 * True Black / Cyan action / City-Light Gold VIP. No 3D globe on `/`.
 */
