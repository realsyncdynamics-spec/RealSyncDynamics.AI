"""Browser evidence capture for website governance audits.

Observable technical signals only; no definitive legal conclusions.
Public-network target restrictions prevent the audit endpoint becoming an SSRF
primitive, including through browser redirects/subresources.
"""
