...
// A live terminal feed with rolling event-stream + 3 right-side aggregate
// counters that tick up as events flow. Once the in-view stream has played
// once, it stays at its final state (no looping noise).
