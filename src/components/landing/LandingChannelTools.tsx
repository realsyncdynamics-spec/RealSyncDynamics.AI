...
const TOOLS = [
  ...
  },
  {
    ...
    icon: Globe2,
    text: 'Ihre Domain. In 30 Sekunden die neue Seite — fotorealistisch, mit Ihren Texten. Erst sehen, dann 328 €. Kein Konto vor der Vorschau.',
    bullets: ['Fotorealistischer Rebuild', 'Ihre Domain-Fotos', '328 € heute, dann Abo'],
    href: '/builder',
