-- Migration: Approval Gates Functions – Phase 1.4
-- collision-check: allow-existing-table runtime_approval_gates — Phase 1.2 schema; Phase 1.3 RLS; Phase 1.4 adds functions only
-- Deferred from Phase 1.2 to separate schema validation from function creation.
-- Phase 1.4 creates the RPC functions needed for approval gate operations.
