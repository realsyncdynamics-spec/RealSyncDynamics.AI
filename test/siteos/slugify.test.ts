 ...
 * (CodeQL js/polynomial-redos, erreichbar über `applyPageEdits`). Das darf
 * das Ergebnis für keine Eingabe ändern — sonst bekäme derselbe Brief einen
 * anderen Hash. Hier steht die frühere Fassung als Vergleichsmaßstab.
 */
