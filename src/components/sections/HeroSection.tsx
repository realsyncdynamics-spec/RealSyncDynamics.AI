...
const LIVE_PILL_LABELS = ['EU-Frankfurt', 'detect', 'monitor', 'govern', 'automate'];
    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        <h1 className="text-center text-5xl sm:text-7xl font-display font-semibold tracking-[-0.02em] text-titanium-50 leading-[1.05] mb-5">
          Ihr Prüfpfad läuft
          <span className="text-cyan-300"> bereits.</span>
        </h1>

        <p className="text-center text-titanium-300 text-base sm:text-xl leading-relaxed max-w-2xl mx-auto mb-10">
          KI-Governance-Runtime für EU-Datenschutz und EU AI Act. Kontinuierliche
          Erkennung, Monitoring, Governance und Automatisierung in einer Ebene.
        </p>
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-[11px] font-mono text-titanium-500">
          ...
          <span className="inline-flex items-center gap-1.5">
            <ShieldCheck className="h-3 w-3 text-emerald-400" /> Kein Setup
          </span>
          <span className="inline-flex items-center gap-1.5">
            <Cpu className="h-3 w-3 text-violet-300" /> EU-Edge · Audit-fähig
          </span>
        </div>
        ...
        <div className="mt-14 sm:mt-20 border border-titanium-900/60">
          <div className="flex items-center gap-2 px-4 py-1.5 bg-obsidian-900/80 border-b border-titanium-900/60">
            ...
            <span className="font-mono text-[9px] uppercase tracking-[0.2em] text-titanium-500 select-none">
              Demo-Runtime · simulierte Events · keine Live-Kundendaten
            </span>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 border-t border-titanium-900 divide-x divide-titanium-900/60">
            <Metric icon={<Activity className="h-3.5 w-3.5 text-cyan-300" />} label="Scans / 24h" value="1,248" delta="Beispiel" deltaColor="text-titanium-600" />
            <Metric icon={<Activity className="h-3.5 w-3.5 text-amber-300" />} label="Drift-Events" value="93" delta="Simuliert" deltaColor="text-titanium-600" />
            <Metric icon={<Cpu className="h-3.5 w-3.5 text-violet-300" />} label="KI-Systeme" value="17" delta="Beispiel" deltaColor="text-titanium-600" />
            <Metric icon={<ShieldCheck className="h-3.5 w-3.5 text-emerald-300" />} label="Evidenzen" value="4,128" delta="Simuliert" deltaColor="text-titanium-600" />
          </div>
        </div>
