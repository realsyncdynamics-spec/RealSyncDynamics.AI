...
export const GOVERN_MODULES: ModuleDefinition[] = [
  { id: 'dsgvo', area: 'govern', name: 'DSGVO', description: 'EU-Datenschutz-Grundverordnung für personenbezogene Daten — Rechtsgrundlagen, Verarbeitungsverzeichnis, Betroffenenrechte, Löschkonzept und Prüfpfad.', icon: 'Shield', policyPack: true },
  { id: 'eu_ai_act', area: 'govern', name: 'EU AI Act', description: 'EU-Verordnung für Künstliche Intelligenz — Risikoklassifizierung, Transparenzpflichten, menschliche Aufsicht, Datenqualität und technische Dokumentation.', icon: 'Brain', policyPack: true },
  { id: 'nis2', area: 'govern', name: 'NIS2', description: 'EU-Richtlinie zur Cybersicherheit wichtiger und kritischer Einrichtungen — Risikoanalyse, Sicherheitsmaßnahmen, Leitungsverantwortung, Meldefristen (24 h / 72 h / 1 Monat).', icon: 'Siren', policyPack: true },
  { id: 'dora', area: 'govern', name: 'DORA', description: 'EU-Verordnung zur digitalen operationalen Resilienz im Finanzsektor — IKT-Risiken, Resilienztests, Incident Reporting und Steuerung von Drittanbietern.', icon: 'Landmark', policyPack: true },
  { id: 'iso_27001', area: 'govern', name: 'ISO 27001', description: 'Internationaler Standard für ein Informationssicherheits-Managementsystem (ISMS) — Risiken, Annex-A-Kontrollen, Verantwortlichkeiten, kontinuierliche Verbesserung.', icon: 'Lock', policyPack: true },
  { id: 'tisax', area: 'govern', name: 'TISAX', description: 'Prüf- und Austauschverfahren der Automobilindustrie für Informationssicherheit, Datenschutz und Prototypenschutz auf Basis des VDA-ISA-Katalogs.', icon: 'Car', policyPack: true },
  { id: 'policy_engine', area: 'govern', name: 'Policy Engine', description: 'Regelwerk als Code — prüft automatisiert, ob Prozesse, Datenzugriffe und KI-Anwendungen die definierten Vorgaben erfüllen, und setzt sie zur Laufzeit durch.', icon: 'Scale' },
  { id: 'evidence_vault', area: 'govern', name: 'Evidence Vault', description: 'Revisionssicherer Nachweisspeicher für Logs, Freigaben, Richtlinienversionen und Prüfprotokolle — mit Hash-Chain, Aufbewahrung und Compliance-Hold.', icon: 'Archive' },
  { id: 'audit_center', area: 'govern', name: 'Audit Center', description: 'Zentraler Bereich für Vorbereitung, Durchführung und Dokumentation von Prüfungen — Kontrollen, Verantwortliche, Feststellungen und exportfähige Nachweispakete.', icon: 'ClipboardCheck' },
  { id: 'risk_register', area: 'govern', name: 'Risk Register', description: 'Zentrale Liste identifizierter Risiken mit Bewertung, Eintrittswahrscheinlichkeit, Auswirkung, Eigentümer, Gegenmaßnahme und Status.', icon: 'AlertTriangle' },
  { id: 'monitoring', area: 'govern', name: 'Monitoring', description: 'Laufende Überwachung von Systemen, KI-Modellen, Datenflüssen und Kontrollen — Abweichungen werden früh sichtbar statt erst im Audit.', icon: 'Activity' },
  { id: 'compliance_reports', area: 'govern', name: 'Compliance Reports', description: 'Berichte über den Erfüllungsstand je Rahmenwerk — offene Risiken, Kontrollen, Maßnahmen und Nachweise als revisionssicher signiertes PDF/JSON.', icon: 'FileText' },
];

export const AUTOMATE_MODULES: ModuleDefinition[] = [
  { id: 'scheduler', area: 'automate', name: 'Scheduler', description: 'Zeitplaner für wiederkehrende Aufgaben — tägliche Compliance-Checks, monatliche Berichte, quartalsweise Risikoprüfungen, mit Prioritäts-Queue.', icon: 'CalendarClock' },
  { id: 'workflows', area: 'automate', name: 'Workflows', description: 'Wiederholbare Prozessketten mit Schritten, Rollen, Bedingungen und Freigaben — etwa für eine Datenschutz-Folgenabschätzung oder die Genehmigung eines KI-Use-Case.', icon: 'GitBranch' },
  { id: 'n8n', area: 'automate', name: 'n8n', description: 'Anbindung an die Workflow-Plattform n8n — Webhook-Trigger verbinden APIs und Dienste, Ergebnisse werden in den Prüfpfad zurückgeschrieben.', icon: 'Workflow' },
  { id: 'kodee', area: 'automate', name: 'Kodee', description: 'Server-Operations-Assistent über SSH — prüft Status, Logs, TLS und DNS; jede Aktion läuft über einen Risiko-Advisor und wird protokolliert.', icon: 'Terminal' },
  { id: 'bulk_jobs', area: 'automate', name: 'Bulk Jobs', description: 'Massenverarbeitung vieler Datensätze oder Domains auf einmal — CSV-Import, Queue und Retry, etwa die Neubewertung aller KI-Anwendungen nach einer Policy-Änderung.', icon: 'Layers' },
  { id: 'automation_engine', area: 'automate', name: 'Automation Engine', description: 'Ausführungslogik hinter den Automationen — startet Trigger, wertet Bedingungen aus, ruft APIs auf, protokolliert Ergebnisse und behandelt Fehler.', icon: 'Cpu' },
  { id: 'alerts', area: 'automate', name: 'Alerts', description: 'Warnmeldungen bei Ereignissen und Regelverstößen — fehlende Nachweise, ablaufende Fristen, kritische Risiken; per E-Mail, Slack, Teams oder Webhook.', icon: 'Bell' },
  { id: 'drift_detection', area: 'automate', name: 'Drift Detection', description: 'Erkennt schleichende Abweichungen vom genehmigten Soll-Zustand — geänderte Konfiguration, abweichendes Modellverhalten, undokumentierte Verarbeitung.', icon: 'TrendingUp' },
  { id: 'remediation', area: 'automate', name: 'Remediation', description: 'Behebung festgestellter Schwachstellen und Abweichungen — Maßnahme, Verantwortlicher, Frist, Code-Snippet, Nachweis und Abschlussprüfung.', icon: 'Wrench' },
  { id: 'background_jobs', area: 'automate', name: 'Background Jobs', description: 'Aufgaben außerhalb der Nutzeranfrage — Berichtserzeugung, Dokumentanalyse, E-Mail-Versand, Synchronisation und periodische Scans, mit Fortschritt und Wiederaufnahme.', icon: 'Cog' },
];

export const ENGAGE_MODULES: ModuleDefinition[] = [
  { id: 'ai_bots', area: 'engage', name: 'AI Bots', description: 'KI-Assistenten, die Fragen beantworten und Aufgaben ausführen — mit Zugriffskontrolle, Transparenzhinweis, Antwort-Logging und Risiko-Tags.', icon: 'Bot' },
  { id: 'voice', area: 'engage', name: 'Voice', description: 'Sprachkanal mit IVR, Speech-to-Text und Text-to-Speech — inklusive Einwilligung bei Aufzeichnung und geschützten Transkripten.', icon: 'Phone' },
  { id: 'whatsapp', area: 'engage', name: 'WhatsApp', description: 'Kanal über die WhatsApp Business Platform — Support, Benachrichtigungen und Dialoge mit Einwilligungsnachweis, Compliance-Badges und Media-Support.', icon: 'MessageCircle' },
  { id: 'telegram', area: 'engage', name: 'Telegram', description: 'Bot-Kanal über die Telegram Bot API — Alerts, Support und interne Freigaben mit identischem Governance-Protokoll.', icon: 'Send' },
  { id: 'website_chat', area: 'engage', name: 'Website Chat', description: 'Eingebetteter Chat auf der eigenen Website — Einwilligung, Datenminimierung, Löschfristen und Gesprächsprotokolle DSGVO-konform geregelt.', icon: 'MessageSquare' },
  { id: 'api', area: 'engage', name: 'API', description: 'REST-Schnittstelle für Scans, Nachweise, Risiken und Automationsläufe — mit Authentifizierung, Berechtigungen, Rate Limits, Versionierung und Prüfpfad.', icon: 'Code' },
  { id: 'webhooks', area: 'engage', name: 'Webhooks', description: 'Signierte HTTP-Benachrichtigungen an eigene Systeme und CI/CD — bei Ereignissen wie „neuer Befund“ oder „Risk Score kritisch“.', icon: 'Webhook' },
  { id: 'human_handoff', area: 'engage', name: 'Human Handoff', description: 'Übergabe vom Bot an einen Menschen — bei Unsicherheit, sensibler Entscheidung oder auf ausdrücklichen Wunsch, mit Eskalationsstufen und Protokollierung.', icon: 'UserCheck' },
  { id: 'multi_channel_messaging', area: 'engage', name: 'Multi Channel Messaging', description: 'Ein Bot über viele Kanäle — Webchat, WhatsApp, Telegram, Voice und API mit gemeinsamer Gesprächshistorie, Routing und einem Prüfpfad.', icon: 'Share2' },
];
