...
// ── Enterprise OS (/os) — eigenständige Public Pages im Enterprise-Designsystem.
// Der frühere App-Prototyp unter /os/app/* ist auf die kanonische /app/*-Runtime
// umgelegt (siehe ./enterprise-os/legacyRouteMap). ──
...
function RoutesWithTracking() {
  ...
  return (
    <>
      ...
      {/* ── Enterprise OS (/os) — eigenständige Public Pages im Enterprise-Designsystem.
          Der App-Layer /os/app/* ist seit 2026-09-14 nur noch Redirect auf /app/*. */}
      <Route path="/os" element={<EnterpriseLandingPage />} />
      {/* Public Pages — eigenständiges Marketing, kein App-State. */}
      ...
      {/* 2026-09-14 — Vereinheitlichung: `/os/app/*` war ein zweiter App-Layer
          mit Mockdaten (kein Backend). Zwei Oberflächen für dieselbe Funktion
          heißen, dass eine davon Ergebnisse nur behauptet. Es bleibt genau eine
          Runtime: `/app/*` inkl. AppGate / RequireAal2 / Entitlement-Gates.
          Die alten Pfade leiten weiter, damit Lesezeichen nicht brechen.
          Mapping: src/enterprise-os/legacyRouteMap.ts */}
