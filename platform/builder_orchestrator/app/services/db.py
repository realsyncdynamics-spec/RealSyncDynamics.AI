"""Datenbankanbindung des Orchestrators (optional).

Ohne `DATABASE_URL` liegen die Task-Graphen im Prozess — der Stack startet
also auch ohne Postgres. Ist die Variable gesetzt, überleben laufende und
abgeschlossene Builds einen Neustart.
"""
...
# Mandant für den Draft — analog zum Governance-Backend.
