/**
 * Design-Lock v2 (2026-09-13): Hollywood Enterprise VIP —
 * True Black · Cyan #22c3e6 (Aktion) · City-Light Gold #f2c98a (VIP-Stufe).
 * Freigabe: Dominik. Referenz: The Governance AI Frontend bundle.
 */
...
export const LANDING_ACCENT_SOFT = '#4fd7f0';
