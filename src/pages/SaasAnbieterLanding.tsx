      ...
      <main className="px-4 sm:px-6 py-12 sm:py-16">
        <div className="max-w-3xl mx-auto space-y-10">
          ...
          <Section title="Pricing für SaaS-Anbieter">
            <ul className="space-y-1.5 text-sm">
              <li><strong className="text-titanium-50">Growth 179 €/M</strong> — Multi-Tenant, API, AVV-Generator, Sub-Processors-Page, alle Tools</li>
              <li><strong className="text-titanium-50">Agency 499 €/M</strong> — bis zu 10 Tenants, dedicated Onboarding, White-Label-Reports, Priority-Support</li>
