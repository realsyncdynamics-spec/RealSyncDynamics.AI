    ...
    <div className="flex flex-col h-full min-h-0 bg-obsidian-950 text-titanium-100">
      <div className="shrink-0 border-b border-titanium-900 bg-obsidian-900 px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 border border-[#00B8D4]/40 hover:border-[#00B8D4] bg-[#00B8D4]/10 hover:bg-[#00B8D4]/15 px-3 py-1.5 text-[11px] font-mono text-[#00B8D4] transition-colors disabled:opacity-50"
          >
        ...
        {TABS.map((tab) => (
          <button
            ...
            className={[
              ...
              activeTab === tab.id
                ? 'border-[#00B8D4] text-titanium-50'
      ...
      {toast && (
        <div className={`fixed bottom-6 right-6 z-50 flex items-center gap-2 px-4 py-2.5 border font-mono text-xs shadow-lg ${
          toast.tone === 'error' ? 'bg-red-950 border-red-800 text-red-200' : 'bg-obsidian-800 border-[#00B8D4]/40 text-[#00B8D4]'
        }`}>
